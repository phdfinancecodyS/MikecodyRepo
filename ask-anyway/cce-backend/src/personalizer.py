...
_MEDS_GUARD_RE = re.compile(
    ...
    r"anti[\-\s]?depress\w+|antidepress\w+|ssris?|snris?|benzo\w*|"
    r"mood\s*stabiliz\w+|stimulant|"
    r"xanax|xanex|xanx|zanax|zanex|"
    r"zoloft|zolft|sertraline|lexapro|lexipro|prozac|prozak|"
    r"wellbutrin|welbutrin|buspar|buspirone|ativan|ativn|"
    r"klonopin|klonipin|clonopin|clonazepam|valium|diazepam|"
    r"celexa|celxa|citalopram|paxil|paroxetine|"
    r"effexor|efexor|venlafaxine|cymbalta|cymbalata|duloxetine|"
    r"trazodone|trazadone|seroquel|seraquil|seroquil|quetiapine|"
    r"abilify|aripiprazole|risperdal|risperidone|zyprexa|olanzapine|"
    r"lithium|lamictal|lamictel|lamotrigine|depakote|depakot|valproate|"
    r"adderall|adderal|adderol|amphetamine|vyvanse|vyvans|lisdexamfetamine|"
    r"ritalin|ritilin|methylphenidate|concerta|strattera|atomoxetine|"
    r"hydroxyzine|gabapentin|gabapenton|ambien|zolpidem|neurontin|"
    r"escitalopram|fluoxetine|bupropion"
    r")\b", re.IGNORECASE,
)
