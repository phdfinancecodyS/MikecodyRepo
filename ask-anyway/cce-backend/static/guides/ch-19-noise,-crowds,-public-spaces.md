...
1. Plan public outings with an exit route already known (aisle seat, door nearest you, clear path out).
2. Go to the same places repeatedly so your nervous system can downregulate recognition.
3. Wear noise-dampening headphones or earplugs to reduce sensory overload.
