...
| Part 1: START IT | Part 2: STAY IN IT | Part 3: WHAT NOW |
|---|---|---|
| Why you stay silent | What you do when they open up | What to do when they confirm SI |
| The myths that freeze | Listening that works | Safety planning |
| The words to use | What NOT to say | Getting them help |
| How to open the door | Holding the space | Caring for yourself |
...
- The family member who's been withdrawing after a loss
...
**Key Concepts:**
- Your first job: stay. Don't end the conversation, don't call 911 immediately, don't fix.
...
| What people say | Why it's harmful | What to say instead |
|---|---|---|
| "You have so much to live for" | Minimizes their pain | "Tell me what's been making it feel unbearable" |
| "Think about your family" | Increases guilt/shame | "I'm here and I'm not going anywhere" |
| "Promise me you won't do anything" | No-harm contracts don't work | "Can we figure out next steps together?" |
| "Have you tried therapy?" | Dismissive, solution-jumping | "What have you already tried? What's helped even a little?" |
| "I had no idea it was this bad" | Centers your feelings | "I'm glad you told me. I want to understand more." |
...
**Key Concepts:**
- Three questions every helper should know how to ask:
...
- The 6 components walked through conversationally:
  ...
  3. Social distractions ("Who or what can take your mind off things?")
  4. People to reach out to ("Who in your life could you call right now?")
  5. Professionals and crisis lines ("Who are your clinical contacts? Do you have 988 saved?")
  6. Means restriction ("Let's talk about making your environment safer")
...
| Part | Module | Topic | Core Tool |
|---|---|---|---|
| **Part 1: Start It** | 1 | Why You Don't Ask | Fear Audit Worksheet |
| | 2 | Seeing the Opening | Scenario Map |
| | 3 | The Words | Script Practice Sheet |
| **Part 2: Stay In It** | 4 | When They Say Yes | Crisis Response Plan |
| | 5 | Listening That Holds | Listening Skills Practice |
| | 6 | What NOT to Say | Script Corrections |
| **Part 3: What Now** | 7 | Understanding the Risk | Risk Conversation Guide |
| | 8 | Safety Planning Together | Safety Planning Conversation Guide |
| | 9 | Getting Them Help + Caring for You | After-Conversation Plan |

---

## Differentiation from Existing Programs

| Program | What It Teaches | What It Misses |
|---|---|---|
| QPR Training | Ask, Persuade, Refer | *How* to ask; what to say after "yes" |
...
## Why This Wins on TikTok

Every module is a TikTok video. Every "what NOT to say" item is a video. Every scripted exchange is a duet or stitch opportunity. The format is inherently viral because:

1. People share things that make them think "I've done that" (the wrong responses module)
2. People save things they want to reference later (the scripts and the risk questions)
3. People tag someone they're worried about (every video in Part 1)
4. Mental health professionals share content that validates what they teach (credibility multiplier)
