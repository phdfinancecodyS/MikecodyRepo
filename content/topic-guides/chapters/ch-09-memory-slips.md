...
1. Stop relying on memory for critical things. Write down anything that matters (conversations, commitments, ideas).
2. Use phone voice notes right when the thought comes so you don't lose it.
3. Schedule repeat conversations for complex topics (don't expect them to stick first pass).
