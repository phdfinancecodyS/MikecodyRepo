...
1. Cut decisions. Have a default for recurring choices (same breakfast, uniform clothes).
2. Make important decisions early in the day when your fuel is full.
3. For the rest of the day, use a coin flip or ask someone else to choose for non-critical decisions.
