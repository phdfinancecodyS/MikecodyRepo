...
1. Name what happened and what values it violated. Don't downplay or reframe.
2. Understand the context (survival, threat, no good options) without using it to excuse the values violation.
3. Begin repair with yourself: What would need to be true for you to move forward?
