...
Base Guide Path: content/topic-guides/chapters/ch-03-hypervigilance-at-home.md
...
2. Map three specific situations at home that trigger the most alarm.
3. For each one, name what your nervous system thinks is happening vs. what's actually happening.
4. Plan one small change in each situation (moving furniture, changing sounds, different timing).
...
- I'm re-learning that this home is safe and I'm not relaxing because of my trigger pattern.
- When I react to [specific thing], it doesn't mean it's actually dangerous.
- I'm working to reset my home-threat association and I need your patience.

## Common Mistakes To Avoid

- Using spiritual language to avoid the actual problem, the actual action step, or the actual support you need.
- Expecting home to feel safe immediately when your nervous system was trained somewhere else.
- Getting angry at yourself for scanning in your own living room instead of naming the pattern.
- Rearranging the house to eliminate triggers instead of teaching your body that this space is different.
