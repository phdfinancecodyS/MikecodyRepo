...
BUCKETS = [
    {
        ...
        "happening": "When your faith matters to you, pain often hits two places at once: your nervous system and your beliefs about God, hope, suffering, and support. The goal here is not to over-spiritualize the problem or ignore faith. It is to tell the truth about what is happening and use support that fits your real life.",
        "step": "Name what is a mental health problem, what is a faith question, and where the two are overlapping so you do not blur them into one knot.",
        "say": [
            "I am struggling, and I do not need a polished answer right now. I need honest support.",
    ...
    },
    {
        ...
        "happening": "Military life trains your body and mind around vigilance, control, performance, and mission. Even after service, those patterns do not disappear just because the environment changed. A lot of the struggle is not weakness. It is training, injury, loss, and identity still showing up in civilian life.",
        ...
        "say": [
            "Part of this is service-related, and I am not going to shame myself for the fact that it still shows up.",
    ...
    },
    {
        ...
        "happening": "First responder culture teaches you to function under pressure, suppress what is inconvenient, and keep moving. That helps on scene. It does not always help off scene. The same skills that keep you effective at work can make home life, sleep, relationships, and emotional recovery a lot harder.",
        "step": "Separate on-scene function from off-scene recovery. What works in the job may be exactly what is breaking things at home.",
        "say": [
            "I know how to perform under pressure. I am still learning how to come down from it.",
            "The fact that I can do the job does not mean the job is not affecting me."
        ],
        "mistake": "Using competence at work as proof that the stress is not costing you anything outside the job.",
    ...
    },
    {
        ...
        "tier": "fallback",
        "what_this": "This version stays broad and practical so it works if you do not want a specific identity lens on the problem.",
        ...
        "step": "Strip the problem down to what is actually happening this week, not the whole story of your life.",
        "say": [
            "This is real, and I can work with what is in front of me right now.",
            "I do not need a perfect plan to take the next useful step."
        ],
        "mistake": "Staying vague about the problem so long that you cannot act on it.",
    ...
    },
    {
        ...
        "happening": "Mental health problems do not land in a vacuum. If you are LGBTQ+, the issue may be sitting on top of identity stress, rejection history, minority stress, hiding, code-switching, or exhaustion from always reading whether a space is safe. That does not mean your identity is the problem. It means the context matters.",
        "step": "Ask whether this problem is being made worse by unsafety, hiding, isolation, or being around people who do not actually let you be known.",
        "say": [
            "I need support that does not make me shrink, explain myself, or scan the room first.",
            "Part of what makes this harder is the environment, not just me."
        ],
        "mistake": "Treating identity stress like it is irrelevant background noise when it is actively shaping the problem.",
        "worksheet1": "Where do you feel most defended, hidden, or on alert in your current environment?",
        "worksheet2": "What is one way to move toward people, places, or routines where you do not have to perform safety all the time?"
    },
    {
        "id": "high-stress-jobs",
    ...
    },
    {
        ...
        "label": "Single Parent",
        "tier": "primary",
        "what_this": "This version is written for single-parent life, where mental health problems hit in the middle of responsibility, no backup, and the pressure to keep functioning even when you are depleted.",
        "happening": "Single-parent stress changes the shape of a problem because there is less margin. You may not get to collapse, sleep in, or hand things off. That means symptoms can get hidden behind competence, and small problems can feel huge because there is not much buffer.",
        ...
        "say": [
            "I am carrying a lot with very little margin, and that changes what support needs to look like.",
            "I do not need judgment. I need practical help and a realistic plan."
        ],
        "mistake": "Setting a support plan that assumes you have extra time, extra childcare, or extra energy that you do not actually have.",
    ...
    },
    {
        ...
        "step": "Ask whether you are applying professional competence to everyone except yourself, and what it is costing you.",
        "say": [
            "I know how to care for people. I am not doing a good job of applying that same honesty to myself right now.",
            "This is not just stress. It is accumulation, moral strain, and not enough recovery."
        ],
    ...
    },
    {
        ...
        "happening": "Education work asks for constant emotional output, patience, attention, and management of other people’s needs. That can make mental health problems feel invisible because you are still performing. But being able to teach or lead a room does not mean you are okay.",
    ...
    },
    {
        ...
        "happening": "Helping professions make it easy to intellectualize your own distress, normalize overload, or keep functioning because you know how to sound okay. But insight is not the same as relief. Secondary trauma, compassion fatigue, and system strain can make your own symptoms harder to admit.",
        "step": "Ask where your helper training is helping and where it is actually making it easier to bypass your own needs.",
        "say": [
            "I know the language of this, and I still need real support for my own life.",
            "Insight is not enough. I need action and recovery too."
        ],
    ...
    },
    {
        ...
        "happening": "Mental health problems can get heavier when they sit on top of racism, code-switching, cultural pressure, isolation, or the constant question of whether a space is safe. That does not mean everything is about race. It means race and racial stress may be increasing the load in ways that matter.",
        "step": "Ask where this problem gets worse because you are carrying extra vigilance, pressure to hold it together, or lack of safe understanding.",
        "say": [
            "Part of this is personal, and part of this is the environment I am trying to function inside.",
            "I need support that sees the full context, not just my symptoms."
        ],
        "mistake": "Treating systemic stress like it is irrelevant background instead of part of the real load you are carrying.",
    ...
    },
    {
        ...
        "happening": "When faith matters to you, mental health problems often carry spiritual questions too: meaning, suffering, discipline, belonging, trust, and how to stay connected without bypassing what is real. The goal is not to flatten faith into generic wellness or turn everything into doctrine. It is to use what is true and usable.",
        ...
        "say": [
            ...
            "I am allowed to honor what is sacred to me without pretending that is the only thing I need."
        ],
    ...
    },
    {
        ...
        "happening": "A lot of mental health advice quietly assumes a nervous system and executive function style that you may not have. If you are neurodivergent, the same problem can hit harder because of sensory overload, task switching, time blindness, social effort, or the cost of masking. That does not mean you are doing it wrong. It means the plan has to fit your brain.",
        "step": "Ask whether this problem is being intensified by sensory overload, masking, executive friction, or the cost of trying to function in a way that does not fit you.",
        "say": [
            "I need a plan that fits how my brain actually works, not advice built for someone else’s system.",
            "Some of this is not laziness or avoidance. It is executive and sensory load."
        ],
    ...
    },
    {
        ...
        "happening": "Grief changes the shape of everything. It lowers capacity, intensifies loneliness, scrambles concentration, and can make normal stress feel enormous. It also does not move in a straight line. The goal is not to rush you past grief. It is to help you function while grief is still part of the room.",
        ...
        "say": [
            "This problem is not happening separate from grief. Grief is part of the load right now.",
            "I do not need to be over this to take a useful next step."
        ],
        ...
        "worksheet2": "What is one way to support yourself this week that respects both the problem and the grief you are carrying?"
    },
    {
        ...
        "happening": "Chronic illness and chronic pain change the rules. Energy is less predictable, symptoms can wipe out capacity fast, and a lot of advice does not account for the real cost of simply getting through a day. Your mental health is affected by both the condition and the life restriction around it.",
    ...
    },
    {
        ...
        "say": [
            "I am not behind because I am struggling. I am carrying a lot while building a life.",
            "I need help that works in real life, not advice from someone pretending this stage is simple."
        ],
        "mistake": "Treating social comparison and instability like they are minor background issues when they are actively driving stress.",
    ...
    },
    {
        ...
        "tier": "primary",
        "what_this": "This version is written for people dealing with addiction, compulsive coping, sobriety, recovery, relapse fear, secrecy, and the work of building a life that does not depend on numbing.",
        "happening": "Addiction and recovery change how mental health problems feel because the urge to numb, escape, control, or disappear is always close by. Even if substances or compulsions are not the main issue today, recovery thinking, shame, secrecy, and relapse fear can still shape the problem hard.",
        "step": "Ask whether this issue is waking up urges to numb, isolate, hide, or tell yourself one slip does not matter.",
        "say": [
            "This is the kind of moment that can push me toward old coping, so I need to move early.",
            "I do not need to handle this alone or in secret."
        ],
...
def build_variant(base_path, bucket):
    ...
    worksheet1 = sections.get("Worksheet 1: Pattern Finder", "").strip()
    worksheet2 = sections.get("Worksheet 2: Action Builder", "").strip()
    ...
    adapted_worksheet1 = inject_worksheet_prompt(worksheet1, bucket["worksheet1"])
    adapted_worksheet2 = inject_worksheet_prompt(worksheet2, bucket["worksheet2"])
