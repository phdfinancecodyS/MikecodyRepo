...
1. Name the symptom pattern and rate intensity from 1-10.
2. Run one grounding or pacing protocol for 90 seconds.
3. Choose one practical adjustment for the next hour.
